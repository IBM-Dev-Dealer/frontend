...
const AddProject = ({ fields }) => {
	...
	const { objectList: requiredCapacity, setObjectList: setRequiredCapacity } =
		useObjectListState();
	const {
		stringInputValue: clientInputValue,
		setStringInputValue: setClientInputValue,
	} = useTextInputState();
	const {
	...
	const {
		stringInputValue: projectNameInputValue,
		setStringInputValue: setProjectNameInputValue,
	} = useTextInputState();
